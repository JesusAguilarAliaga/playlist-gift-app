...
const CasettesList = () => {
  ...
  return (
    <section className="relative max-w-[570px] mx-auto pt-20 pb-10 px-16 mt-[65px] flex flex-col gap-[15px] items-center rounded-lg bg-gradient-to-r from-[rgba(61,46,149,0.35)] to-[#3D2E95] max-sm:mx-3 max-sm:mt-[20px] max-sm:px-4">
