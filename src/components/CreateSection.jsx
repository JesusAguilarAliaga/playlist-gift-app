...
import CreateListTracks from "./CreateListTracks"
...
const CreateSection = () => {
  ...
  return (
    <section className="relative max-w-[570px] mx-auto py-10 px-16 mt-28 flex flex-col gap-[25px] items-center rounded-lg bg-gradient-to-r from-[rgba(61,46,149,0.35)] to-[#3D2E95] max-sm:mx-3 max-sm:px-4">
      <Link to={"/home"}>
      ...
      {addedList.map((track) => (
        <CreateListTracks key={track.id} track={track} />
      ))}
    </ul>
    </section>
